...
Lee and Wagenmakers introduce us to modeling with a series of examples of inferring rates.
...
// accepts only theta, the rate, which is bound at 0 (no chances of success) and 1 (always success)
parameters {
  real<lower=0, upper=1> theta;
}
...
Then we fit the model and assess the estimates
